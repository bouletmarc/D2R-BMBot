...
namespace app
{
    public class ItemsAlert
    {
        ...
        public bool ShouldPickItem(bool Keeping)
        {
            ...
            {
                if (Form1_0.ItemsStruc_0.ItemNAAME == "Lacquered Plate"         //# Tal Rasha's Guardianship
                    || Form1_0.ItemsStruc_0.ItemNAAME == "Death Mask"           //# Tal Rasha's Horadric Crest
                    || Form1_0.ItemsStruc_0.ItemNAAME == "Mesh Belt"            //# Tal Rasha's Fine Spun Cloth
                    || Form1_0.ItemsStruc_0.ItemNAAME == "Sacred Armor"         //# Immortal King
                    || Form1_0.ItemsStruc_0.ItemNAAME == "Heavy Bracers"        //# Trang-Oul's Claws
                    || Form1_0.ItemsStruc_0.ItemNAAME == "Winged Helm"          //# Guillaume's Face
                    || Form1_0.ItemsStruc_0.ItemNAAME == "Russet Armor"         //# Aldur's Advance
                    || Form1_0.ItemsStruc_0.ItemNAAME == "Swirling Crystal")    //# Tal Rasha's Lidless Eye
                {
                    return true;
                }
            }
